...
export class TransactionService {
  ...
  async getPendingTransactions(): Promise<Transaction[]> { // Indica que la función devuelve una Promesa que, cuando se resuelva, contendrá un array de objetos del tipo Transaction.
  ...
  async removeTransaction(transaction: Transaction) {
    ...
    this.storage.executeSql(query, [transaction.id]) // id de la transacción será utilizado para identificar la fila a eliminar.
